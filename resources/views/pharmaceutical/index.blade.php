...
@section('content')
    <div class="text-center mt-5">
        <h1 class="title">مرحبا صيدلي/ة {{Auth::user()->name}}</h1>
    </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="card p-4 rounded-5 shadow-sm col-lg-3 col-md-6 col-sm-8 mb-4 m-4">
                    <div class="start-card text-center p-4 d-flex flex-column align-items-center">
                        ...
                        <h5 class="fw-bold mb-3"> اضافة دواء </h5>
                        <p class="text-muted">اضافة دواء جديد <br>
                            للمخزون
                        </p>
                        <a href="{{route('medicines.create')}}" class="btn btn-primary mt-auto w-100 rounded-5">إضافة</a>
                    </div>
                </div>
                ...
                <div class="card p-4 rounded-5 shadow-sm col-lg-3 col-md-6 col-sm-8 mb-4 m-4">
                    <div class="start-card text-center p-4 d-flex flex-column align-items-center">
                        ...
                        <h5 class="fw-bold mb-3"> عرض المخزون </h5>
                        <p class="text-muted">عرض قائمة الأدوية والتحكم في تفاصيلها</p>
                        <a href="{{route('medications')}}" class="btn btn-primary mt-auto w-100 rounded-5">عرض</a>
                    </div>
                </div>
